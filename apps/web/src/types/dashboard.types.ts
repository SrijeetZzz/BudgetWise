...
export interface DashboardBudgetAlert {
  _id: string;
  scope: "OVERALL" | "CATEGORY" | "SUBCATEGORY";
  ...
  categoryId?: string | DashboardCategory | null;
  subcategoryId?: string | DashboardCategory | null;
}
...
export interface DashboardRecentTransaction {
  ...
  currency: string;
  paymentMethod?: DashboardPaymentMethod | null;
...
export type MonthlyComparisonTrend = "INCREASE" | "DECREASE" | "NO_CHANGE";
...
export interface DashboardData {
  ...
  categoryWiseSpend: DashboardCategorySpending[];

  subcategoryWiseSpend: DashboardSubcategorySpending[];
  ...
  upcomingRecurringTransactions: DashboardUpcomingRecurringTransaction[];
}
...
export interface DashboardAnalytics {
  incomeVsExpenseTrend: DashboardIncomeExpenseTrend[];

  expenseTrend: DashboardExpenseTrend[];

  categoryTrend: DashboardCategoryTrend[];

  paymentMethodBreakdown: DashboardPaymentMethodBreakdown[];

  cashFlowTrend: DashboardCashFlowTrend[];
}
