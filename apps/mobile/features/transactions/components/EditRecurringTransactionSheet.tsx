...
interface EditRecurringTransactionSheetProps {
...
export default function EditRecurringTransactionSheet({
  transaction,
  visible,
  onClose,
}: EditRecurringTransactionSheetProps) {
  /*
   * =========================================================
   * THEME
   * =========================================================
